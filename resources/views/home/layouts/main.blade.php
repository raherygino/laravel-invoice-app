                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                <div class="menu-item px-3">
                                                    <a href="account/settings.html" class="menu-link d-flex px-5 active">
                                                        ...
                                                        {{ trans('settings.languages.french') }}
                                                    </a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                                        ...
                                                        {{ trans('settings.languages.english') }}
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div 
                                ...
                                <div data-kt-menu-trigger="click"  class="menu-item menu-accordion" >
                                    <span class="menu-link" >
                                        ...
                                        <span  class="menu-title" >{{ trans('menu.products.title') }}</span>
                                    ...
                                    <div  class="menu-sub menu-sub-accordion" >
                                        <div  class="menu-item" >
                                            <a class="menu-link"  href="pages/user-profile/overview.html" >
                                                ...
                                                <span  class="menu-title" >{{ trans('menu.products.add') }}</span>
                                            </a>
                                        </div>
                                        <div  class="menu-item" >
                                            <a class="menu-link"  href="pages/user-profile/projects.html" >
                                                ...
                                                <span  class="menu-title" >{{ trans('menu.products.list') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click"  class="menu-item menu-accordion" >
                                    <span class="menu-link" >
                                        ...
                                        <span  class="menu-title" >{{ trans('menu.invoices.title') }}</span>
                                        <span  class="menu-arrow" ></span>
                                    </span>
                                    <div  class="menu-sub menu-sub-accordion" >
                                        <div  class="menu-item" >
                                            <a class="menu-link"  href="#" >
                                                ...
                                                <span  class="menu-title" >{{ trans('menu.invoices.add') }}</span>
                                            </a>
                                        </div>
                                        <div  class="menu-item" >
                                            <a class="menu-link"  href="#" >
                                                ...
                                                <span  class="menu-title" >{{ trans('menu.invoices.list') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click"  class="menu-item menu-accordion" >
                                    <span class="menu-link" >
                                        ...
                                        <span  class="menu-title" >{{ trans('menu.customers.title') }}</span>
                                        <span  class="menu-arrow" ></span>
                                    </span>
                                    <div  class="menu-sub menu-sub-accordion" >
                                        <div  class="menu-item" >
                                            <a class="menu-link"  href="#" >
                                                ...
                                                <span  class="menu-title" >{{ trans('menu.customers.add') }}</span>
                                            </a>
                                        </div>
                                        <div  class="menu-item" >
                                            <a class="menu-link"  href="#" >
                                                ...
                                                <span  class="menu-title" >{{ trans('menu.customers.list') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div  class="menu-item">
                                    <a class="menu-link" href="#" target="_blank" >
                                        ...
                                        <span  class="menu-title" >{{ trans('menu.charges.title') }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="kt_app_footer" class="app-footer">
                            <div class="app-container  container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3 ">
                                <div class="text-dark order-2 order-md-1">
                                    <span class="text-muted fw-semibold me-1">2023&copy;</span> Design & developped by
                                    <a href="https://keenthemes.com/" target="_blank" class="text-gray-800 text-hover-primary">Gino</a>
                                </div>
                                <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                                    <li class="menu-item"><a href="https://raharygino. github.io" target="_blank" class="menu-link px-2">Développeur</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
